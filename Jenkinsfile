        ...
        stage('Regression Automation Tests') {
            steps {
                catchError(buildResult: 'SUCCESS', stageResult: 'FAILURE') {
                    git 'https://github.com/ChinmayDandeen88/POMDesign'
        ...
        stage('Publish ChainTest HTML Report'){
            steps{
                     publishHTML([allowMissing: false,
                                  ...
                                  keepAll: true, 
                                  reportDir: '/Users/chinmayrameshdandeen/Documents/Java_selenium/Code_Base/March2025PMSeries/target/chaintest/Index.html', 
